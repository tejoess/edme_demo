<h1 align="center">🚀 Edme Insurance Policy Management</h1>
<h2 align="center">Insurance Comparison, Recommendation & Claim Assistant</h2>

<p align="center"><b>Local quick start (3 commands):</b></p>

<pre>
# 1) Database (Postgres 16 in Docker, schema + seed auto-loaded, port 5434)
docker compose up -d
...
<p align="center">After first setup, the recurring 3 commands are simply:<br>
<code>docker compose up -d</code> &nbsp;·&nbsp; <code>.venv\Scripts\uvicorn main:app --reload</code> (in <code>backend/</code>) &nbsp;·&nbsp; <code>npm start</code> (in <code>frontend/</code>)</p>
